...
const ValidationDemoComponent = defineComponent({
    ...
    return () =>
      h('div', { style: { padding: '2rem', maxWidth: '900px', margin: '0 auto' } }, [
        h(
          ...
          [
            h('h1', '유효성 검증 데모'),
            h('p', { style: { color: '#666' } }, '다양한 검증 규칙 테스트 (required, min/max, pattern)'),
          ]
        ),
        h(FormRenderer, {
