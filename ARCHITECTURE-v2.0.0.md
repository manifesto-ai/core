...
> **Note:** v2 focuses on **Core, Host, World, App**. Translator is deprecated and not part of the active layer model.
...
```typescript
// Host's world view
createHost(schema, { onTrace }); // emits TraceEvent via callback
...
- [World Protocol v2.0.2 SPEC](./packages/world/docs/world-SPEC-v2.0.2.md)
- [World Protocol v2.0.2 FDR](./packages/world/docs/world-FDR-v2.0.2.md)
- [Host Contract v2.0.2 SPEC](./packages/host/docs/host-SPEC-v2.0.2.md)
- [Host Contract v2.0.2 FDR](./packages/host/docs/host-FDR-v2.0.2.md)
