...
> **Version:** 0.1.0
> **Status:** Stable
> **Full Specification:** [SPEC-0.1.0v](/packages/intent-ir/SPEC)
...
- [Full SPEC Document](/packages/intent-ir/SPEC)
- [Design Rationale (FDR)](/packages/intent-ir/FDR)
- [Package README](/packages/intent-ir/README)
