...
> **Current Contract Note:** This page reflects the current Core v4.1.0 error model. `lastError` remains the sole current error surface; accumulated `system.errors` and `SystemDelta.appendErrors` are removed.
