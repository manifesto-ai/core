...
- direct action submission through `@manifesto-ai/sdk`
- the optional approval/history runtime

The runtime entry differs, but failures still become state and runtime records rather than control-flow escapes.
