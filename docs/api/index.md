...
| Request a transition | [Actions and Availability](./actions-and-availability) |
...
| Package | Use When |
|---------|----------|
| [@manifesto-ai/sdk](./sdk) | You want the base app runtime |
| [@manifesto-ai/lineage](./lineage) | You need restore, branch/head history, or sealed records |
| [@manifesto-ai/governance](./governance) | You need proposals, approval flow, decisions, and approval events |
| [@manifesto-ai/compiler](./compiler) | You need MEL compilation, lowering, or bundler adapters |
| [@manifesto-ai/codegen](./codegen) | You need generated domain facades |
