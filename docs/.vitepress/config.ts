...
const guideSidebar: DefaultTheme.SidebarItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Lineage Records', link: '/concepts/lineage-records' },
      ...
      '/internals/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'ADR-003: Superseded Persistence Draft', link: '/internals/adr/003-world-owns-persistence' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'World Facade', link: '/internals/retired/world' },
          ]
        },
      ],
    },
