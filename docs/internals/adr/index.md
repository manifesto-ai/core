...
|----|-------|---------|--------|
| [ADR-001](https://github.com/anthropics/manifesto-ai/blob/main/workspaces/core/packages/translator/core/docs/translator-ADR-001-v1.0.8.md) | Clean Architecture | v1.0.8 | Accepted |
| [ADR-002](https://github.com/anthropics/manifesto-ai/blob/main/workspaces/core/packages/translator/core/docs/translator-ADR-002-v0.11.md) | Decompose Layer Design | v0.11 | Accepted |
| [ADR-003](https://github.com/anthropics/manifesto-ai/blob/main/workspaces/core/packages/translator/core/docs/translator-ADR-003-v0.11.md) | Decompose Layer Compliance | v0.11 | Accepted |
