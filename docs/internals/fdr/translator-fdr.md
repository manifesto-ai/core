...
- Fixed §8.5 `contentSummary` keys: `schemaCount` → `schemaSnapshotCount`, `glossaryCount` → `glossaryTermCount`
...
| T028 | Memory | ~~Memory Enhances All Stages~~ → Stage 5/6 Only |
...
1. [Overview](#overview)
2. [Foundational Architecture Decision (FAD-001)](#foundational-architecture-decision-fad-001)
3. [Core Philosophy Decisions](#core-philosophy-decisions)
4. [Data Model Decisions](#data-model-decisions)
5. [Pipeline Decisions](#pipeline-decisions)
6. [Identity & Determinism Decisions](#identity--determinism-decisions)
7. [Memory Integration Decisions](#memory-integration-decisions)
8. [Ambiguity & Resolution Decisions](#ambiguity--resolution-decisions)
9. [Configuration Decisions](#configuration-decisions)
10. [Summary Table](#summary-table)
11. [Cross-Reference: Related FDRs](#cross-reference-related-fdrs)
12. [Manifesto Ecosystem Integration Decisions](#manifesto-ecosystem-integration-decisions)
13. [Memory Architecture Decisions](#memory-architecture-decisions)
