...
export const LINEAGE_SPEC_INVENTORY: readonly LineageComplianceInventoryItem[] = [
  ...
  ...inventoryMany(
    ["LIN-SEAL-PURE-1", "LIN-STORE-4", "LIN-HEAD-ADV-1", "MRKL-TIP-1", "MRKL-TIP-2", "MRKL-HEAD-5"],
    "§7.1/§10.2/§11.2",
    "MUST",
    "branch",
  ),
  ...inventoryMany(
    ["MRKL-ATTEMPT-2", "MRKL-REUSE-1", "MRKL-REUSE-2", "MRKL-STORE-4"],
    "§5.4/§8.2/§11.2",
    "MUST",
    "attempts",
  ),
  ...inventoryMany(
    ["MRKL-RESTORE-1", "MRKL-RESTORE-2", "MRKL-RESTORE-3", "MRKL-RESTORE-3a", "MRKL-RESTORE-4"],
    "§14.1",
    "MUST",
    "restore",
  ),
