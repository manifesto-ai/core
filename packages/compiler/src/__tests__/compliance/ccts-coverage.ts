...
export const COMPILER_RULE_COVERAGE: readonly CompilerComplianceCoverageEntry[] = [
  ...coverMany(["A1"], [CCTS_CASES.GRAMMAR_CANONICAL_SURFACE, CCTS_CASES.DETERMINISM_COMPILE]),
  ...
  ...coverMany(["A4"], [CCTS_CASES.CONTEXT_COMPUTED_SYSTEM, CCTS_CASES.CONTEXT_STATE_INIT_SYSTEM, CCTS_CASES.CONTEXT_AVAILABLE_PURITY]),
  ...coverMany(["A5", "A6"], [CCTS_CASES.GRAMMAR_CANONICAL_SURFACE]),
  ...coverMany(["A7"], [CCTS_CASES.ACTIONS_GUARDED_BODY]),
  ...coverMany(["A8"], [CCTS_CASES.IR_SYSTEM_LOWERING, CCTS_CASES.DETERMINISM_COMPILE]),
  ...
  ...coverMany(["A15"], [CCTS_CASES.IR_TOTAL_EVALUATION]),
  ...coverMany(["A18"], [CCTS_CASES.DETERMINISM_COMPILE]),
