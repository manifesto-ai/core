...
- **SPEC:** [v0.4.0](SPEC-v0.4.0-patch.md) (Patch - requires v0.3.3)
- **FDR:** [v0.4.0](FDR-v0.4.0-patch.md) (Patch - requires v0.3.3)

**Note:** v0.4.0 is a patch document. Read [SPEC-v0.3.3.md](SPEC-v0.3.3.md) first.
