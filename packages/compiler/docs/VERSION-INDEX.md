...
**Note:** v0.5.0 SPEC is now consolidated. Patch documents remain for historical context.
...
|---------|------|-----|------|--------|
| v0.5.0 | [SPEC](SPEC-v0.5.0.md) | [FDR](FDR-v0.5.0-patch.md) | Full | Draft |
...
2. For rationale: [FDR-v0.3.3.md](FDR-v0.3.3.md) + [FDR-v0.5.0-patch.md](FDR-v0.5.0-patch.md)
