...
> **Historical Note:** The current living Compiler contract is [SPEC-v1.2.0.md](SPEC-v1.2.0.md). This file is retained for pre-v1 MEL design history.
> **Changelog:**
...
### Summary
64. [Summary: The MEL Identity](#summary-the-mel-identity)
65. [Appendix: Decision Dependency Graph](#appendix-decision-dependency-graph)
66. [Appendix: v0.3.1 to v0.3.3 Changes](#appendix-v031-to-v032-changes)
...
*End of MEL FDR Document v0.3.3*
