...
> **Current Contract Note:** This guide follows the current Host v4.0.0 surface. Host-facing Snapshot references now follow Core v4.1.0 and no longer include accumulated `system.errors`.
