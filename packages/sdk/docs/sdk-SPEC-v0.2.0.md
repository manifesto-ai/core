...
This document defines the **Manifesto SDK Specification v0.2.0**.
...
| Runtime SPEC | v0.2.0 | Internal orchestration (companion spec) |
| Core SPEC | v3.0.0 | Snapshot, DomainSchema, PatchPath/SystemDelta |
| Host Contract | v3.0.0 | EffectHandler signature (adapted by Runtime) |
| World Protocol | v3.0.0 | World, WorldId, governance |
...
*End of Manifesto SDK Specification v0.2.0*
