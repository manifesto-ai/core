...
export const ACTION_SINGLE_PARAM_OBJECT_VALUE = Symbol(
  "manifesto-sdk.action-single-param-object-value",
);
export const RUNTIME_KERNEL_FACTORY = Symbol(
  "manifesto-sdk.runtime-kernel-factory",
);
