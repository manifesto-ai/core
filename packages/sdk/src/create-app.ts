...
import type { App, AppConfig, Effects, MelText } from "@manifesto-ai/shared";
import { ReservedEffectTypeError, RESERVED_EFFECT_TYPE } from "@manifesto-ai/shared";
...
/**
 * @deprecated Use `createClient()` instead. Will be removed in v3.
 */
...
/**
 * Create a new Manifesto Client instance.
 *
 * Preferred entry point for v3+. Alias for `createApp()`.
 *
 * @see SPEC v2.3.0 §6.1
 */
export function createClient(config: AppConfig): App {
  return createAppFromConfig(config);
}
