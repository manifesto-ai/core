...
export type RuntimePublicationFacet<T extends ManifestoDomainShape> = Pick<
  RuntimeKernel<T>,
  "getVisibleCoreSnapshot" | "setVisibleSnapshot" | "rehydrateSnapshot" | "restoreVisibleSnapshot"
>;

export type RuntimeReportingFacet<T extends ManifestoDomainShape> = Pick<
  RuntimeKernel<T>,
  "deriveExecutionOutcome" | "classifyExecutionFailure" | "createExecutionDiagnostics"
>;
...
export type LineageRuntimeKernel<T extends ManifestoDomainShape> = RuntimePublicReadFacet<T> &
...
export type GovernanceRuntimeKernel<T extends ManifestoDomainShape> = RuntimePublicReadFacet<T> &
  RuntimeLifecycleFacet<T> &
  RuntimeExecutionFacet<T> &
  RuntimeSealAdmissionFacet<T> &
  RuntimeReportAdmissionFacet<T> &
