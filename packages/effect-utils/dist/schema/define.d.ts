 ...
 * ```
 */
export declare function defineEffectSchema<TType extends string, TInput extends z.ZodType, TOutput extends z.ZodType>(config: EffectSchemaConfig<TType, TInput, TOutput>): EffectSchema<TType, TInput, TOutput>;
