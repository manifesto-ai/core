...
1. Start with [SPEC-v0.1.1](SPEC-v0.1.1.md) for the current normative contract, including ADR-025 Snapshot ontology and ADR-026 SDK v5 domain facade alignment.
2. Read [ADR-CODEGEN-001](ADR-CODEGEN-001.md) for the original plugin architecture decisions and design rationale.
3. Read ADR-026 for the SDK v5 action-candidate surface that generated facades must target.
