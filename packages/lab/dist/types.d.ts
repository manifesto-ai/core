 ...
 */
import type { ManifestoWorld, Proposal, Snapshot, IntentScope, WorldEvent, AuthorityHandler } from "@manifesto-ai/world";
/**
 ...
 */
export type VerificationGuarantee = "certain" | "consistent" | "plausible" | "confirmed";
/**
 ...
 */
export type ProjectionView = "progress" | "proposals" | "snapshot" | "llm" | "hitl" | "trace";
/**
 ...
 */
export type LabTraceEventType = "proposal" | "authority.decision" | "apply" | "effect" | "effect.result" | "hitl" | "termination" | "world.created" | "failure.explanation";
/**
 * Base trace event.
 */
 ...
 */
export type LabTraceEvent = ProposalTraceEvent | AuthorityDecisionTraceEvent | ApplyTraceEvent | EffectTraceEvent | EffectResultTraceEvent | HITLTraceEvent | TerminationTraceEvent | WorldCreatedTraceEvent | FailureExplanationTraceEvent;
/**
 * Trace outcome.
 */
 ...
 */
export type FailureReason = "NO_EXECUTABLE_ACTION" | "GOAL_UNREACHABLE" | "AUTHORITY_REJECTION" | "UNRESOLVED_AMBIGUITY" | "HUMAN_REQUIRED" | "TIMEOUT" | "RESOURCE_EXHAUSTED";
/**
 ...
 */
export type LabEventType = "hitl:pending" | "hitl:decided" | "lab:status_changed" | "world:event";
/**
 ...
 */
export type DivergenceType = "authority_decision" | "proposal_content" | "execution_result" | "effect_result" | "hitl_decision" | "timing" | "unknown";
/**
 ...
 */
export type ReplayMode = "strict" | "lenient" | "compare";
/**
 ...
 */
export type SnapshotRenderer = (snapshot: Snapshot, context: RenderContext) => string;
/**
 * Action renderer for intent visualization.
 */
export type ActionRenderer = (intent: unknown, before: Snapshot, after: Snapshot, context: RenderContext) => string;
/**
 * Proposal renderer for proposal visualization.
 */
export type ProposalRenderer = (proposal: Proposal, context: RenderContext) => string;
/**
 * Reasoning renderer for LLM reasoning visualization.
 */
export type ReasoningRenderer = (reasoning: string, confidence: number, context: RenderContext) => string;
/**
 ...
 */
export type PendingReasonCode = "LOW_CONFIDENCE" | "AMBIGUOUS_INTENT" | "REQUIRES_CONFIRMATION" | "SCOPE_EXCEEDED" | "RESOURCE_LIMIT";
/**
