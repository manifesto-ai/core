 ...
 */
export function retry(description, hint) {
    return {
        type: "retry",
 ...
 */
export function modify(allowedModifications, description) {
    return {
        type: "modify",
 ...
 * @param description - Optional description
 */
export function requestInfo(suggestedQuestions, description) {
    return {
        type: "request_info",
 ...
 * @param description - Optional description
 */
export function escalate(to, description) {
    return {
        type: "escalate",
 ...
 */
export function defaultLowConfidenceActions() {
    return [
        retry("Retry with more context", "Provide additional information to increase confidence"),
        modify(["input", "parameters"], "Modify the proposal parameters"),
        requestInfo(["What is the expected outcome?", "Are there any constraints?"], "Ask clarifying questions"),
 ...
 */
export function defaultAmbiguousIntentActions() {
    return [
        requestInfo(["Which interpretation is correct?"], "Clarify the intended interpretation"),
 ...
 */
export function defaultConfirmationActions() {
    return [
 ...
 */
export function defaultScopeExceededActions() {
    return [
 ...
 */
export function defaultResourceLimitActions() {
    return [
 ...
 */
export function getDefaultActions(code) {
    switch (code) {
        case "LOW_CONFIDENCE":
