 ...
 *
 * Target-agnostic extension hint. Generalizes the concept of
 * "melCandidates" to support multiple target types.
 *
 * Per SPEC Section 11.9 (EXP-*):
 * - EXP-7: Core SHALL NOT use "melCandidates" terminology
