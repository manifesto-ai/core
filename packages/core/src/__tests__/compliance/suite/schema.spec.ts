...
import { caseTitle, createComplianceSchema, expectValidationCode, pp } from "./helpers.js";

describe("Core CTS schema validation", () => {
  it(
    caseTitle(CORE_CTS_CASES.SCHEMA_VALIDATION, "validates schema rule ids V-001 through V-010"),
    () => {
  ...
  it(
    caseTitle(
      ...
      "rejects reserved state identifiers and computed runtime reads",
    ),
    () => {
