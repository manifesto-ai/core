...
export const CORE_COMPLIANCE_CASES: readonly CoreComplianceCase[] = [
  ...
  complianceCase(CORE_CTS_CASES.DYNAMIC_FLOW_PATCH_TARGETS, "compute-and-flow", "Dynamic Flow patch targets resolve inside Core compute and emit concrete patches."),
...
export const CORE_RULE_COVERAGE: readonly CoreComplianceCoverageEntry[] = [
  ...
  ...coverMany(["FLOW-PATH-1", "FLOW-PATH-2", "FLOW-PATH-3", "FLOW-PATH-4", "FLOW-PATH-5"], [CORE_CTS_CASES.DYNAMIC_FLOW_PATCH_TARGETS]),
