...
| Minimal | Boundary rules | SPEC 4 | `packages/app/src/__tests__/v2-standard-integration.test.ts` | partial | AppConfig injection not enforced |
...
| Standard | Hook system | SPEC 17 | `packages/app/src/__tests__/hooks.test.ts`, `packages/app/src/__tests__/publish-boundary.test.ts`, `packages/app/src/__tests__/v2-standard-integration.test.ts` | partial | AppRef and hook isolation missing |
