...
import { GOVERNANCE_COMPLIANCE_RULES, getRulesBySuite } from "./gcts-rules.js";
import { GOVERNANCE_SPEC_INVENTORY } from "./gcts-spec-inventory.js";
import { GOVERNANCE_COMPLIANCE_CASES, GOVERNANCE_RULE_COVERAGE } from "./gcts-coverage.js";
