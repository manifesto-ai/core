...
> **License:** MIT
> **Historical Note:** This document is retained as the initial split-native governance baseline. The current governance decorator contract now lives in [governance-SPEC.md](governance-SPEC.md).
