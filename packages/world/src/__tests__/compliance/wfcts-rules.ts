...
export const WORLD_FACADE_COMPLIANCE_RULES: readonly WorldFacadeComplianceRule[] = [
  ...
  registry("FACADE-STORE-4", "blocking"),
  registry("FACADE-STORE-6", "blocking"),
  registry("FACADE-STORE-7", "blocking"),
  registry("FACADE-WS-1", "blocking"),
  registry("FACADE-WS-2", "blocking"),
  registry("FACADE-WS-3", "blocking"),
  registry("FACADE-WS-4", "blocking"),
  ...registryMany(["FACADE-COORD-1", "FACADE-COORD-2", "FACADE-COORD-3", "FACADE-COORD-4", "FACADE-COORD-5", "FACADE-COORD-6", "FACADE-COORD-7", "FACADE-COORD-8", "FACADE-COORD-9", "FACADE-COORD-11"], "blocking"),
