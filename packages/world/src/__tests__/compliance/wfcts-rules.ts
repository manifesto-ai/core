...
export const WORLD_FACADE_COMPLIANCE_RULES: readonly WorldFacadeComplianceRule[] = [
  ...
  ...registryMany(["FACADE-RUNTIME-1", "FACADE-RUNTIME-2", "FACADE-RUNTIME-3", "FACADE-RUNTIME-4", "FACADE-RUNTIME-5", "FACADE-RUNTIME-6", "FACADE-RUNTIME-7", "FACADE-RUNTIME-8", "FACADE-RUNTIME-9", "FACADE-RUNTIME-10", "FACADE-RUNTIME-11", "FACADE-RUNTIME-12"], "blocking"),
