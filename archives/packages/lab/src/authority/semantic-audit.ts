 ...
 */
export function createSemanticAuditAuthority(
  ...
  return {
    ...
    async evaluate(
      ...
      const interpretedRule = input?.interpretedRule as Record<string, unknown> | undefined;
      ...
      const validation = interpretedRule.validation as Record<string, unknown> | undefined;
      ...
      const confidence = interpretedRule.confidence as string | undefined;
      ...
      const assumptions = interpretedRule.assumptions as
        | Array<{ impact: string }>
        | undefined;
