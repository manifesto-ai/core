 ...
 * @see SPEC-1.2v §10
 */
import type { Proposal, ProposalTrace } from "@manifesto-ai/world";
 ...
 */
export function attachToProposal<P extends Proposal>(
  proposal: P,
  trace: MemoryTrace
): P {
 ...
 */
export function getFromProposal(proposal: Proposal): MemoryTrace | undefined {
  ...
  if (
    ...
    return memoryTrace as MemoryTrace;
  }
 ...
 */
export function hasTrace(proposal: Proposal): boolean {
